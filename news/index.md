...
- As the version number is not present anymore in the XSD schema,
  replace the validation message in the console with the XSD schema URL.
...
- add unit tests
- returns error message with suggestions if node or variable doesn’t
  exist
