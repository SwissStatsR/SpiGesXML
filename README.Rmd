...
By default, the functions use the "latest" format validation version, which is currently the SpiGes version 1.5. The section [Change format version](## Change format validation version) below provides examples how to change manually the version.
